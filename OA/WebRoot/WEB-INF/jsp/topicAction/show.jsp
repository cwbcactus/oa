				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr valign="bottom">
						...
						<td class="ForumPageTableTitle" align="right"
							style="padding-right:12px;"><s:a class="detail"
						...
						<table border="0" cellpadding="0" cellspacing="1" width="100%">
							...
							<tr>
								...
								<td class="Footer" height="28" align="center" valign="bottom">
									<ul style="margin: 0px; width: 98%;">
										<li style="float: left; line-height:18px;"><font
											color=#C30000>[${(pageNum - 1)*pageSize + status.count}楼]</font> <s:date
					...
					<table border="0" cellspacing="1" width="98%" cellpadding="5"
						...
						<tr class="Tint" height="200">
							...
							<td valign="top" class="no_color_bg"><s:textarea
									name="content" cssStyle="width: 95%; height: 300px"></s:textarea>
							</td>
						</tr>
