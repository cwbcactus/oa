					...
					<tbody id="TableData">
						<tr class="TableDetail1">
							...
							<td>
								...
								<%-- 使用Struts2的标签显示复选框，有回显功能，但不方便修改显示效果(无法控制换行效果)。
								...
								<s:iterator value="#privileges">
									<input type="checkbox" name="privilegeIds" value='<s:property value="id"/>' id="cb_<s:property value='id'/>"
									<s:property value="%{ id in privilegeIds ? 'checked' : ''}"/>
									>
									<label for="cb_<s:property value='id'/>"><s:property value="name"/></label><br>
								</s:iterator>
								--%>
								...
								<%-- 显示为树状结构（使用<ul>标签） --%>
									<ul id="tree">
										...
										<li>
											<input type="checkbox" name="privilegeIds" value='<s:property value="id"/>' id="cb_<s:property value='id'/>"
											<s:property value="%{ id in privilegeIds ? 'checked' : ''}"/>>
											<label for="cb_<s:property value='id'/>"><span class='folder'><s:property value="name"/></span></label><br>
