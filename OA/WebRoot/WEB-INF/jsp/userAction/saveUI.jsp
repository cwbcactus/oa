...
<!--显示表单内容-->
<div id=MainArea>
    <s:form action="userAction_%{id==null ? 'add' : 'edit'}" method="post">
        ...
        <div class="ItemBlockBorder">
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    ...
                    <tr><td>登录名</td>
                        <td><s:textfield name="loginName" cssClass="InputStyle {required:true, minlength:3, maxlength:12, messages:{required:'请输入登录名!!'}}"/> *
							（登录名要唯一）
						</td>
                    </tr>
                    <tr><td>姓名</td>
