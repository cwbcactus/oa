    ...
    <table cellspacing="0" cellpadding="0" class="TableStyle">
        ...
        <tbody id="TableData" class="dataContainer" datakey="departmentList">
			...
			<tr class="TableDetail1 template">
				<td><s:a action="departmentAction_list?parentId=%{id}"><s:property value="name"/></s:a>&nbsp;</td>
				<td><s:property value="parent.name"/>&nbsp;</td>
				<td><s:property value="description"/>&nbsp;</td>
				<td><s:a onClick="return window.confirm('这将删除所有的下级部门，您确定要删除吗？')" action="departmentAction_delete?id=%{id}&parentId=%{parent.id}">删除</s:a>
